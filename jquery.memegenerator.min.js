...
!function (e) {
    var t = {
        ...
        this.settings = e.extend(!0, {}, {
            defaultTextStyle: {
                color: "#FFFFFF", size: 42, lineHeight: 1.2,
                font: "Impact, arial", style: "normal", forceUppercase: !0, borderColor: "#000000", borderWidth: 2
            },
            defaultDrawingStyle: {color: "#FF0000", lineWidth: 10},
            minFontSize: 1,
            maxFontSize: 128,
            minBorderWidth: 0,
            maxBorderWidth: 10,
            ...
            forceUppercase: i.settings.defaultTextStyle.forceUppercase, dragResizeEnabled: i.settings.dragResizeEnabled,
            drawingAboveText: i.settings.drawingAboveText
        }, this.element = a, this.wrapper = null, this.canvasContainer = null, this.helpersContainer = null, this.canvasLayers = [], this.originalSize = [], this.scale = 1,
            this.initialized = !1, this.save = function () {
            ...
            a.wrap('<div class="mg-wrapper"><div class="mg-image"></div></div>'),
                i.wrapper = a.parent().parent(), i.canvasContainer = e('<div class="mg-canvas"></div>').appendTo(i.wrapper.find("> .mg-image")), i.helpersContainer = e('<div class="mg-helpers"></div>').appendTo(i.wrapper.find("> .mg-image")),
            "horizontal" == i.settings.layout && i.wrapper.addClass("mg-horizontal-layout"), "css" == i.settings.previewMode && i.cssPreview.enable(), e("<img>").attr("src", a.attr("src")).on("load", function () {
                i.originalSize[0] = this.width,
                    i.originalSize[1] = this.height, i.scale = a.width() / i.originalSize[0], i.settings.editingEnabled && i.wrapper.append(i.ui.createControls()),
                    i.settings.captions.forEach(function (e, t) {
                        ...
                        i.userSettings.forceUppercase && (e = i.ui._strtoupper(e)), a.attr("value", e), a.attr("data-text", e), a.trigger("change")
                    }), i.settings.useBootstrap ? i.ui.bootstrapify() : i.settings.useWordpressStyle && i.ui.wordpressify(),
                    i.initialized = !0, i.settings.onInit.call(i)
            }), e(window).on("resize", function () {
                i.scale = a.width() / i.originalSize[0], i.events.onLayerChange()
            }), a.on("load.mg", function () {
                i.initialized && (i.originalSize[0] = this.naturalWidth,
                    i.originalSize[1] = this.naturalHeight, i.scale = a.width() / i.originalSize[0], i.ui.resizeHelpers(), i.events.onLayerChange())
            })
        }, this.ui = {
            createControls: function () {
                ...
                if (e(n).click(function (e) {
                        ...
                        i.settings.useBootstrap ? i.ui.bootstrapify() : i.settings.useWordpressStyle && i.ui.wordpressify(),
                            t.find("input[type=text]").first().focus(), i.settings.onNewTextBox.call(i, t)
                    ...
                    s.append(e('<div class="option"></div>').append(e('<input type="checkbox" class="mg-option-uppercase">')).append(e("<label>" + t.optionCapitalLetters + "</label>"))),
                        a.find(".mg-option-uppercase").prop("checked", i.userSettings.forceUppercase), a.find(".mg-option-uppercase").change(function (t) {
                        t.preventDefault(), i.userSettings.forceUppercase = e(this).is(":checked"),
                            i.userSettings.forceUppercase ? (a.find(".mg-textbox-text").css("textTransform", "uppercase"), a.find(".mg-textbox-text").each(function () {
                                e(this).val(i.ui._strtoupper(e(this).val()))
                            }),
                                i.events.onLayerChange()) : a.find(".mg-textbox-text").css("textTransform", "none")
                    }), s.append(e('<div class="option"></div>').append(e('<input type="checkbox" class="mg-option-dragresize">')).append(e("<label>" + t.optionDragResize + "</label>"))),
                        a.find(".mg-option-dragresize").prop("checked", i.userSettings.dragResizeEnabled), a.find(".mg-option-dragresize").change(function (t) {
                        t.preventDefault(), i.userSettings.dragResizeEnabled = e(this).is(":checked"),
                            i.ui.destroyPositionHelpers(), i.userSettings.dragResizeEnabled && a.find(".mg-textbox").each(function () {
                            i.ui.createPositionHelper(e(this))
                        })
                    }), s.append(e('<div class="option"></div>').append(e('<input type="checkbox" class="mg-option-drawing-above-text">')).append(e("<label>" + t.optionDrawingAboveText + "</label>"))),
                        a.find(".mg-option-drawing-above-text").prop("checked", i.userSettings.dragResizeEnabled), a.find(".mg-option-drawing-above-text").change(function (t) {
                        t.preventDefault(), i.userSettings.drawingAboveText = e(this).is(":checked"),
                            i.userSettings.drawingAboveText ? (i.wrapper.find(".mg-canvas canvas, .mg-css-preview").css("zIndex", 3), i.wrapper.find(".mg-canvas, .mg-canvas .mg-drawing-layer").css("zIndex", 4)) : (i.wrapper.find(".mg-canvas canvas, .mg-css-preview").css("zIndex", 4),
                                i.wrapper.find(".mg-canvas, .mg-canvas .mg-drawing-layer").css("zIndex", 3))
                ...
                return o.append('<div class="mg-toolbox-item"><button class="mg-drawing-toggle">' + t.drawingStart + "</button></div>"), o.append('<div class="mg-toolbox-item"><input type="text" class="colorpicker" value="' + i.settings.defaultDrawingStyle.color + '"></div>'),
                    o.append('<div class="mg-toolbox-item"><input type="number" class="mg-drawing-line-width" value="' + i.settings.defaultDrawingStyle.lineWidth + '"></div>'), o.append('<div class="mg-toolbox-item"><button class="mg-drawing-erase">' + t.drawingErase + "</button></div>"),
                    o.find(".mg-drawing-toggle").click(function () {
                ...
                return l.append(e('<input type="text" class="mg-textbox-text" placeholder="' + t + '" data-text="' + n.text + '" value="' + n.text + '">')), l.append(e('<input type="number" class="mg-textbox-size" value="' + n.fontSize + '" step="' + i.settings.fontSizeStep + '" min="' + i.settings.minFontSize + '" max="' + i.settings.maxFontSize + '">')),
                i.userSettings.forceUppercase && l.find(".mg-textbox-text").css("textTransform", "uppercase"), 0 != i.settings.colorPicker && (l.append('<input type="text" class="mg-textbox-text-color colorpicker" value="' + n.color + '">'),
                    l.append('<input type="text" class="mg-textbox-border-color colorpicker" value="' + n.borderColor + '">'), l.find(".colorpicker").wrap('<div class="colorpickerContainer"></div>'), i.ui._bindColorpicker(l.find(".colorpicker"))),
                    l.append(e('<input type="number" class="mg-textbox-border-width" value="' + n.borderWidth + '" step="' + i.settings.borderWidthStep + '" min="' + i.settings.minBorderWidth + '" max="' + i.settings.maxBorderWidth + '">')), i.canvasLayers.push(r),
                    l.find(".mg-textbox-text, .mg-textbox-size, .mg-textbox-border-width").on("change keyup", function () {
                        var t = e(this).val();
                ...
                n.css({
                    ...
                    n.resizable({
                        containment: i.wrapper.find("> .mg-image > img"), resize: function (e, t) {
                            var n = i.wrapper.find("[data-layer='" + a + "']");
            ...
            resizeHelpers: function () {
                i.helpersContainer.find("> div").each(function () {
                    var t, a, n, r = i.wrapper.find("[data-layer='" + e(this).attr("data-target-layer") + "']"),
                        s = null;
                    if (r.attr("data-width") && (t = parseInt(r.attr("data-width"), 10) * i.scale,
                        t > i.helpersContainer.width() && (t = i.helpersContainer.width()), e(this).css("width", t), r.attr("data-width", parseInt(t * (1 / i.scale), 10))), r.attr("data-height") && (a = parseInt(r.attr("data-height"), 10) * i.scale, e(this).css("height", a),
                            e(this).resizable("option", "minHeight", a), e(this).resizable("option", "maxHeight", a)), r.attr("data-x") && r.attr("data-y") && (n = r.attr("data-x") * i.scale, n + t > i.helpersContainer.width() && (n = i.helpersContainer.width() - t), n < 0 && (n = 0),
                            s = r.attr("data-y") * i.scale, s + a > i.helpersContainer.height() && (s = i.helpersContainer.height() - a), s < 0 && (s = 0), e(this).css({
                            left: n,
                            top: s
                        }), r.attr("data-x", parseInt(n * (1 / i.scale), 10)), r.attr("data-y", parseInt(s * (1 / i.scale), 10))),
            ...
            bootstrapify: function () {
                ...
                i.wrapper.hasClass("usingBootstrap") || t.wrapInner('<div class="container-fluid"></div>'), i.wrapper.addClass("usingBootstrap"), t.find(".mg-textbox").each(function () {
                    e(this).hasClass("row") || (e(this).addClass("row"),
                        e(this).find(".mg-textbox-text").addClass("form-control").wrap(e("<div></div>").addClass("col-md-4")), e(this).find(".mg-textbox-size").addClass("form-control").wrap(e("<div></div>").addClass("col-md-2")),
                        e(this).find(".mg-textbox-border-width").addClass("form-control").wrap(e("<div></div>").addClass("col-md-2")), e(this).find(".colorpicker").addClass("form-control"), e(this).find(".colorpickerContainer").addClass("col-md-2"),
                        e(this).find(".colorpickerReplacer").addClass("btn btn-default"))
                }), t.find(".mg-add-textbox").hasClass("btn") || t.find(".mg-add-textbox").addClass("btn btn-default btn-block").wrap(e("<div></div>").addClass("row")),
                t.find(".mg-advanced-settings-toggle").hasClass("btn") || (t.find(".mg-advanced-settings-toggle, .mg-toolbox-toggle").addClass("btn btn-primary btn-block").wrap(e("<div></div>").addClass("row")),
                    t.find(".mg-advanced-settings, .mg-toolbox").addClass("row"), t.find(".mg-advanced-settings .option input").wrap('<div class="col-md-1"></div>'), t.find(".mg-advanced-settings .option label").wrap('<div class="col-md-11"></div>')),
                t.find(".mg-drawing-toggle").hasClass("btn") || (t.find(".mg-drawing-toggle, .mg-drawing-erase").addClass("btn btn-default btn-block"), t.find(".mg-toolbox-item").addClass("col-md-3"))
            },
            wordpressify: function () {
                var e = i.wrapper.find(".mg-controls");
                i.wrapper.addClass("usingWordpress"), e.find(".mg-add-textbox").hasClass("button") || e.find(".mg-add-textbox").addClass("button button-secondary"),
                e.find(".mg-advanced-settings-toggle").hasClass("button") || e.find(".mg-advanced-settings-toggle, .mg-toolbox-toggle").addClass("button button-primary"), e.find(".mg-drawing-toggle").hasClass("button") || e.find(".mg-drawing-toggle, .mg-drawing-erase").addClass("button button-secondary")
            },
            _bindColorpicker: function (t) {
                if (null == i.settings.colorPicker && e.isFunction(e.fn.spectrum)) {
                    var a = function (t) {
                        e(this).val(t.toHexString()), e(this).attr("value", t.toHexString()), e(this).trigger("change"),
                            i.events.onLayerChange(e(this).parent().data("layer"))
                    };
                    t.spectrum({replacerClassName: "colorpickerReplacer", change: a, move: a})
                } else null == i.settings.colorPicker ? t.on("change keyup",
                    function () {
            ...
            return i.canvasLayers.forEach(function (t) {
                var a = i.wrapper.find("[data-layer='" + t + "']"), n = i.getLayerType(a);
                switch (n) {
                    case"text":
                        return void e.push({
                            type: n,
            ...
            drawLayers: function (e) {
                ...
                var v = parseInt(a, 10) + parseInt(r, 10) / 2, w = parseInt(n, 10) + parseInt(s, 10),
                    o = s * parseFloat(o), m = i.canvas._wrapText(u, t, r);
            ...
            enable: function () {
                ...
                return p.css({
                    ...
                    textShadow: function (e, t) {
                        var a = "";
                        return [[-1, -1], [-1, 1], [1, -1], [1, 1]].forEach(function (n, i) {
    ...
    e.fn.memeGenerator = function (n) {
        ...
        if (i) {
            var r = [], s = arguments.length > 1 ? Array.prototype.slice.call(arguments, 1) : void 0, o = [];
            return "i18n" == i ? void e.extend(t, s[1]) : (this.each(function () {
                var t = e(this), a = t.data("memeGenerator");
                r.push(a)
